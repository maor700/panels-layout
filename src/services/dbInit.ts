...
treesDB.on('populate', async () => {
  ...
  await treesDB.treesItems.bulkPut([
    ...
    { id: 'second_panel_1', order: 100, parentPath: `${secondTreeId}/`, treeId: 'second-tree', leaf: 1, name: 'second_panel_1', type: PanelTypes.row, flex: 50 },
    { id: 'second_panel_2', order: 200, parentPath: `${secondTreeId}/`, treeId: 'second-tree', leaf: 1, name: 'second_panel_2', type: PanelTypes.row, flex: 50 },
  ]);
});
