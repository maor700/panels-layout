...
treesDB.on('ready', async () => {
  ...
  await treesDB.treesItems.bulkPut([
    ...
    { id: 'panel_3', color:"green", order: 300, parentPath: `${id}/`, treeId: TREE_NAME, leaf: 0, name: 'panel_3', activeTab:"panel_4", type: PanelTypes.tabs, flex: 33, hideHeader: 1 },
    { id: 'panel_4', color:"pink", order: 10, parentPath: `${id}/panel_3/`, treeId: TREE_NAME, leaf: 1, name: 'panel_4', type: PanelTypes.content, flex: 75 },
